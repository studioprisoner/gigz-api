...
export const schemas: SchemaDefinition[] = [
	...
	},
	{
		...
		fields: {
			...
			notes: { type: "String" },
			setlist: { type: "Array" },
			setlist_id: { type: "String" },
			setlist_unavailable: { type: "Boolean", defaultValue: false },
		...
		indexes: {
			...
			user_date_index: { user: 1, concert_date: -1 },
		},
	...
	},
	{
		...
		fields: {
			user: { type: "Pointer", targetClass: "_User", required: true },
			concert: { type: "Pointer", targetClass: "Concert" },
	...
	},
	{
		...
		indexes: {
			concert_created_index: { concert: 1, createdAt: -1 },
			user_index: { user: 1 },
